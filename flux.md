...
- The `types.compose` API is useful for composing models, actions, and views defined individually. This is useful for applications that may want to share/reuse actions and views with various models. Additionally, this approach is useful for providing models with generic actions functionality (shared fetch and error handling for example).
