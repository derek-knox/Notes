...
3. The PATH is a persistent Environment Variable denoting a list of OS directory paths where executable programs reside. Symblinks may be set in the path to denote an alias to a certain program or program version.
